(define (problem waypoint_following)
    ...
    (:objects   tiago - robot
		        ...
		        wp_table_2_left wp_table_3_left - waypoint
    ...
    ;; DEFINE YOUR INITIAL STATE
        ...
        (robot-at tiago wp0)
        (free rightgrip)
        ;;(free leftgrip) ;; Left gripper NOT used in this version
        ...
        ;; Waypoint of the following changed to pick up with the right gripper
        (object-at aruco_cube_444 wp_table_3_left)  
        (object-at aruco_cube_582 wp_table_2_left)
        ...
        ;; The following cubes are added under rightgripper because 
        ;; leftgripper is NOT used in this version
        (pick-right rightgrip aruco_cube_444)  
        (pick-right rightgrip aruco_cube_582)  
        
        ;; Define which cube should be picked with the left gripper
        ;; Left gripper NOT used in this version
