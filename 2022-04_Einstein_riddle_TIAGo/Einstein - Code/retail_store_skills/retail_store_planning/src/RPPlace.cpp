...
namespace KCL_rosplan {
	...
	// The action implementation goes here.
		...
		PlaceClient ac("place_server_right", true);
		...
		*/
		...
		if(!use_aruco){
			...
			_nh.getParam("/locations/" + msg->parameters[5].value + "/position", position);
			_nh.getParam("/locations/"+ msg->parameters[5].value + "/orientation", orientation);
