...
#include <ros/ros.h>
#include <custom_msgs/PlaceAction.h>
...
bool RPPlaceInterface::concreteCallback(
  ...
  typedef actionlib::SimpleActionClient<custom_msgs::PlaceAction> PlaceClient;
